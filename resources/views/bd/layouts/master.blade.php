...
<body>
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('bd.dashboard') }}" class="sidebar-brand">
                <img src="{{ asset('bti logo 1.png') }}" alt="BTI Logo">
            </a>
        </div>
        <div class="sidebar-nav">
            <a href="{{ route('bd.dashboard') }}" class="{{ request()->routeIs('bd.dashboard') ? 'active' : '' }}">
                <i class="fas fa-tachometer-alt"></i>
                Dashboard
            </a>
            <a href="{{ route('bd.proposals.index') }}" class="{{ request()->routeIs('bd.proposals.*') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-custom">
            <div class="d-flex align-items-center">
                ...
                <h1 class="navbar-brand mb-0">BD CRM – Business Developer Dashboard</h1>
            </div>
            <div class="ms-auto d-flex align-items-center">
                ...
                <div class="dropdown">
                    <button class="btn btn-link dropdown-toggle d-flex align-items-center text-decoration-none" type="button" data-bs-toggle="dropdown">
                        ...
                        <span class="text-dark">{{ $me->name ?? 'BD User' }}</span>
                    </button>
    ...
    <script>
        ...
        class ToastNotification {
            ...
            primary(title, message) { this.show('primary', title, message); }
        }
        ...
        function initDynamicAvatars(root=document) {
            ...
            avatars.forEach((el) => {
                ...
                if (el.getAttribute('data-bs-toggle') === 'tooltip' && window.bootstrap) {
